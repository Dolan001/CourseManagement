			...
			<div class="row">
				<div class="col-lg-4 col-md-6 service-item">
					...
					<div class="si-content">
						<h5><a href="course-management?action=assign_course" style="text-decoration: none; color: black;">Assign Course</a></h5>
				...
				<div class="col-lg-4 col-md-6 service-item">
					...
					<div class="si-content">
						<h5><a href="course-management?action=course_info" style="text-decoration: none; color: black;">Course information</a></h5>
						<p>Donec molestie tincidunt tellus sit amet aliquet. Proin auctor nisi ut purus ele ifend, et auctor lorem hendrerit. </p>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 service-item">
					...
					<div class="si-content">
						<h5><a href="course-management?action=students_info" style="text-decoration: none; color: black;">Student's information</a></h5>
						<p>Donec molestie tincidunt tellus sit amet aliquet. Proin auctor nisi ut purus ele ifend, et auctor lorem hendrerit. </p>
					</div>
				</div>
			</div>
