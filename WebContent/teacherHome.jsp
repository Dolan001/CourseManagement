		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7">
					...
					<p>Online course management system helps to manage courses and this system is more reliable than manual management system</p>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 service-item">
					...
					<div class="si-content">
						<h5><a href="teacher-course-management?action=reged_course" style="text-decoration: none; color: black;">Registered Courses</a></h5>
				...
				<div class="col-lg-4 col-md-6 service-item">
					...
					<div class="si-content">
						<h5><a href="teacher-course-management?action=allcourse" style="text-decoration: none; color: black;">All Courses</a></h5>
						<p>Donec molestie tincidunt tellus sit amet aliquet. Proin auctor nisi ut purus ele ifend, et auctor lorem hendrerit. </p>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 service-item">
					...
					<div class="si-content">
						<h5><a href="teacher-course-management?action=reged_students" style="text-decoration: none; color: black;">Registered Students</a></h5>
						<p>Donec molestie tincidunt tellus sit amet aliquet. Proin auctor nisi ut purus ele ifend, et auctor lorem hendrerit. </p>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="footer-bottom">
				...
				<div class="footer-logo">
					<a href="#" ><p id="title_name">Scheduler</p></a>
				</div>
			</div>
